...
let deliveryMessage = "";
	$(function() {
		...
		$("#selectedNonEmail").on("change", function(){

			if($("option:selected", this).text() == "직접입력") {
				$('#directEmailInput').attr('style', 'display:');
				console.log("hi");
			} else {
				$('#directEmailInput').attr('style', 'display:none');	
			}
			});
	...
	function packData() {
	      ...
	      if($("select[name=nonEmailSelection] option:selected").text() == "직접입력") {
	    	  selectedEmail = $('#directEmailInput').val();
	      } else {
	    	  selectedEmail = $("select[name=nonEmailSelection] option:selected").text();
	      }
...
<body>
	...
	<section class="checkout-section-2 section-b-space">
		...
		<form action="orderComplete" method="post" id="requestNonOrder">
			<input type="hidden" name="orderNo" id="nonOrderNo" value="">
														...
														<div class="delivery-address-box">
															...
															-->
																...
																<ul class="delivery-address-detail">
																	...
																	<li>
																		<h6 class="text-content">
																			...
																			<button type="button" class="greenBtn"
																				onclick="sample6_execDaumPostcode('addZipNo', 'addAddr', 'addAddrDetail', 'addExtraAddress');">주소 찾기</button>
																	...
																	<li>
																		<h6 class="text-content mb-0">
																			<span class="text-title">이메일: </span><br><input
																				class="form-control" style="width:143px !important;display:inline-block;" name="nonEmail" id="nonEmail">
																			@
																			<div class="col-6" style="display:inline-block;">
																			<div class="select-option">
																				<div class="form-floating theme-form-floating">
																			<select class="form-select theme-form-select" name="nonEmailSelection" id="selectedNonEmail">
																			<option>이메일</option>
																	...
																	<li><input type="text" class="form-control"
																		id="directEmailInput" name="directEmail" placeholder=""
