...
public class OrderDAOImpl implements OrderDAO {
	...
	public CompleteOrder getPaymentHistory(String orderNo) throws Exception {
		Map<String, Object> map = determineOrder(orderNo);
		// 회원 주문, 비회원 주문 판별
		
		CompleteOrder orderDetail = ses.selectOne(ns + ".getPaymentDetail", map);
		System.out.println(orderDetail.toString());
		return orderDetail;
	}

	private Map<String, Object> determineOrder(String orderNo) {
		Map<String, Object> map = new HashMap<>();
	...
	public List<String> getProductIds(String orderNo) throws Exception {
		...
		List<String> productIds = ses.selectList(ns+".getProductIds", map);
		return productIds;
	}
